  ...
  <caption><?php echo Yii::t("default","Merchant List")?></caption>
   <thead>
        <tr>
            ...
            <th width="7%"><?php echo Yii::t("default","App Enabled?")?></th>            
            ...
            <th width="5%"><?php echo Yii::t("default","Country")?></th>
            <?php else :?>
            <th width="5%"><?php echo Yii::t("default","Street address")?></th>
            <th width="3%"><?php echo Yii::t("default","post code")?></th>
            <?php endif;?>
            <th width="4%"><?php echo Yii::t("default","Contact")?></th>
            <th width="4%"><?php echo Yii::t("default","Order Status")?></th>
            <th width="4%"><?php echo Yii::t("default","Current Status")?></th>
            <th width="4%"><?php echo Yii::t("default","Charges Type")?></th>
