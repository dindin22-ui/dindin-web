...
<li><a href="#"><?php echo Yii::t("default","Uber Eats")?></a></li>
...
<li>
    ...
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo Yii::t("default","Uber Eats Store ID")?></label>
        <?php echo CHtml::textField('uber_eats_store_id',
            isset($data['uber_eats_store_id'])?$data['uber_eats_store_id']:""
            ,array(
                'class'=>'uk-form-width-large'
            ))?>
    </div>
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo Yii::t("default","Uber Eats Store Status")?></label>
        <?php
        echo CHtml::checkBox('uber_eats_status',
            $data['uber_eats_status']=="ONLINE"?true:false
            ,array(
                'value'=>"ONLINE",
                'class'=>"icheck"
            ))
    ...
    <div class="uk-form-row" style="display: none">
		<label class="uk-form-label"><?php echo Yii::t("default","Uber Eats Developer Key")?></label>
		<?php echo CHtml::textField('uber_eats_key',
		isset($data['uber_eats_key'])?$data['uber_eats_key']:""
		,array(
		'class'=>'uk-form-width-large'
		))?>
		</div>  
		...
		<div class="uk-form-row" style="display: none">
		<label class="uk-form-label"><?php echo Yii::t("default","Uber Eats Developer Secret")?></label>
		<?php echo CHtml::textField('uber_eats_secret',
		isset($data['uber_eats_secret'])?$data['uber_eats_secret']:""
		,array(
		'class'=>'uk-form-width-large'
		))?>
		</div>  
...
<div class="uk-form-row invoice_terms_wrap">
  ...
  <div class="uk-form-row">
    <label class="uk-form-label"><?php echo Yii::t("default","Any Fee?")?></label>
    <?php echo CHtml::textField('any_fee',
    isset($data['any_fee'])?stripslashes($data['any_fee']):""
    ,array(
    'class'=>'uk-form-width-small'
    ));?>
</div>
    ...
    <div class="uk-form-row">
        <label class="uk-form-label"><?php echo Yii::t("default","Doordash Fee?")?></label>
        <?php echo CHtml::textField('doordash_fee',
            isset($data['doordash_fee'])?stripslashes($data['doordash_fee']):""
            ,array(
                'class'=>'uk-form-width-small'
            ));?>
    </div>
