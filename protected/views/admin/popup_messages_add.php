...
<?php echo CHtml::hiddenField('action','addAdminPopupMessage')?>
<?php echo CHtml::hiddenField('id',isset($_GET['id'])?$_GET['id']:"");?>
<?php if (!isset($_GET['id'])):?>
<?php echo CHtml::hiddenField("redirect",Yii::app()->request->baseUrl."/admin/AdminPopupMessages/Do/Add")?>
<?php endif;?>

<?php 
if (isset($_GET['id'])){
	if (!$data=Yii::app()->functions->getPopUpMessageAdmin($_GET['id'])){
...
<?php
$merchant_list = FunctionsV3::merchantList(true,true);

$merchant_ids = (array)json_decode($data['merchant_id']);


?>

<div class="uk-form-row">
  <label class="uk-form-label" style="padding-right:5px;"><?php echo Yii::t("default","Select Merchant")?></label>
  <?php echo CHtml::dropDownList('merchant_id[]',$merchant_ids,(array)$merchant_list,array(
