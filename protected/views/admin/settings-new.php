...
<ul id="uk_tab" data-uk-tab="{connect:'#tab-content'}" class="uk-tab uk-active">
  ...
  <li><a href="#"><?php echo t("Book a Table")?></a></li>
    <li><a href="#"><?php echo t("Doordash Drive API")?></a></li>
...
<ul class="uk-switcher uk-margin uk_tab" id="tab-content" style="padding:15px 10px;">
  ...
  <li class="uk-active">
	...
	?> 
      ...
      <div class="uk-form-row">
          <label class="uk-form-label"><?php echo Yii::t("default","Send Notification to?")?></label>
          <?php
          echo CHtml::textField('notify_email',
              Yii::app()->functions->getOptionAdmin('notify_email'),
              array(
                  'class'=>"uk-form-width-large",
	...
	<div class="uk-form-row">
          <label class="uk-form-label"><?php echo Yii::t("default","Non comfirmed orders notification")?></label>
          <?php 
          echo CHtml::textArea('non_confirmed_order_emails',getOptionA('non_confirmed_order_emails'),array(
          'class'=>"uk-form-width-large"
          ))?>
          <p class="uk-text-muted"><?php echo t("Multiple email addresses separated by comma")?></p>
      </div>
	<?php 
...
<!--<div class="uk-form-row">
  ...
  <p class="uk-text-muted indent" >
    ...
    <li><!-- Doordash Drive API-->

        <div class="uk-form-row">
            <label class="uk-form-label"><b><?php echo t("Drive API")?>:</b></label>

            <ul>
                <li>
                    <?php echo CHtml::radioButton('drive_api_mode',
                        yii::app()->functions->getOptionAdmin('drive_api_mode')=="sandbox"?true:false,array(
                            'class'=>"icheck",
                            'value'=>"sandbox"
                        ))?>
                    <?php echo t("Sandbox")?>
                ...
                <li style="padding-left:170px;">
                    <?php echo CHtml::radioButton('drive_api_mode',
                        yii::app()->functions->getOptionAdmin('drive_api_mode')=="live"?true:false,array(
                            'class'=>"icheck",
                            'value'=>"live"
                        ))?>
                    <?php echo t("Live")?>
        ...
        <div class="uk-form-row">
            <label class="uk-form-label"><?php echo t("API Key (sandbox)")?></label>
            <?php
            echo CHtml::textField('drive_api_key_sandbox',
                getOptionA('drive_api_key_sandbox'),
                array(
                    'class'=>"uk-form-width-large",
        ...
        <div class="uk-form-row">
            <label class="uk-form-label"><?php echo t("API Key (live)")?></label>
            <?php
            echo CHtml::textField('drive_api_key_live',
                getOptionA('drive_api_key_live'),
                array(
                    'class'=>"uk-form-width-large",
                    'placeholder'=>t("Api Key")
                ))
