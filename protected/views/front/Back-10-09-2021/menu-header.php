...
.weblink { color: #fff500; } /* CSS link color */
...
<div class="mobile-banner-wrap relative mobile_banner_custom" style="background-image: url('<?php echo empty($background)?assetsURL()."/images/b-2-mobile.jpg":uploadURL()."/$background"; ?>');background-size: cover;
