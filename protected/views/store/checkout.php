  ...
  <div class="row">
	  ...
	  <div class="col-md-6 border" >
        ...
        <?php echo CHtml::hiddenField('currentController','store')?>
         <?php echo CHtml::hiddenField('redirect',Yii::app()->createUrl('/cart'))?>
        ...
        // print_r($_SESSION['kr_client'];  $this->createUrl('/store/guestcheckout');
            ?>
		  <a href="<?php echo $this->createUrl('/cart');?>"
	               class="orange-button medium block full-width"><center><?php echo t("Continue as guest")?></center></a>
	               </br>
