...
$ratings=Yii::app()->functions->getRatings($merchant_info);
$merchant_info=array(   
...
?>
<div class="sections section-menu hide_on_desktop" style="padding-top: 0px">
<div class="container">
  <div class="row">

     <div class="col-md-8 border menu-left-content">
         
        <div class="tabs-wrapper" id="menu-tab-wrapper" style="border: none;">
	   <!-- <ul id="tabs">
		    <li class="active">
		...
		<!--MENU-->
	    <li class="active" id="menu_left_content" style="display: none">
