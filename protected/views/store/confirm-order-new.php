            ...
            <!-- <i class="order-icon your-order-icon"></i> -->
             ...
             <div class="order-list-wrap">   
	           ...
	           <div class="text-center top25">
	             <a href="javascript:;" class="place_order green-button medium inline block full-width">
        ...
        <div class="col-md-7">
          <div class="box-grey rounded">
           ...
           <table class="table-order-details">
            ...
            <?php 
			if (isset($s['kr_delivery_options']['delivery_asap'])):?>
            ...
            <?php endif;?>
            <?php endif;?>
            <?php if (isset($s['kr_delivery_options']['delivery_time']) && $show_actual_time):?>
            ...
            <?php if (!empty($s['kr_delivery_options']['delivery_asap']) && $transaction_type =='delivery'):
				$show_actual_time = false;
				?>
            <tr>
