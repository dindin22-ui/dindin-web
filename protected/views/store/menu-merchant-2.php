                    ...
                    <div class="m1 menu-scroll" id="menu-scroll-fixed">
                        <div id="menu-center">
                            <ul id="menu-center-ul">
                                ...
                                ?>
                                    <li><a <?php if($i == 0){ ?>class="active" <?php } ?> href="#<?php echo $css_id; ?>"><?php echo $menu_val['category_name']; ?></a></li>
                                <?php
                                    if($i == 3){
                                        ?>
                                    <?php
                                    ...
                                    <div class="col-md-6" style="padding-left:5px;padding-right:5px;">
                                        <div class="box-grey" style="padding:0; margin: 0">
                                            ...
                                            <div class=" xs_p0">
                                                ...
                                                <div class="food_item_left" <?php if (!file_exists($path) || empty($val_item['photo'])){ echo 'style="width:100%";clear:both'; }?>>
                                                    <a href="javascript:;"
