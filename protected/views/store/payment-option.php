...
if(isset($_SESSION['kr_delivery_options']['street'])){
    $client_info['street'] = $_SESSION['kr_delivery_options']['street'];
}
if(isset($_SESSION['kr_delivery_options']['state'])){
    $client_info['state'] = $_SESSION['kr_delivery_options']['state'];
}
if(isset($_SESSION['kr_delivery_options']['city'])){
    $client_info['city'] = $_SESSION['kr_delivery_options']['city'];
}
if(isset($_SESSION['kr_delivery_options']['zipcode'])){
    $client_info['zipcode'] = $_SESSION['kr_delivery_options']['zipcode'];
}
if(isset($_SESSION['kr_delivery_options']['location_name'])){
    $client_info['location_name'] = $_SESSION['kr_delivery_options']['location_name'];
}
if(isset($_SESSION['kr_delivery_options']['contact_phone'])){
    $client_info['contact_phone'] = $_SESSION['kr_delivery_options']['contact_phone'];
}
if(isset($_SESSION['kr_delivery_options']['email_address'])){
    $client_info['email_address'] = $_SESSION['kr_delivery_options']['email_address'];
}
if(isset($_SESSION['kr_delivery_options']['first_name'])){
    $client_info['first_name'] = $_SESSION['kr_delivery_options']['first_name'];
}
if(isset($_SESSION['kr_delivery_options']['last_name'])){
    $client_info['last_name'] = $_SESSION['kr_delivery_options']['last_name'];
}
if(isset($_SESSION['kr_delivery_options']['delivery_instruction'])){
    $client_info['delivery_instruction'] = $_SESSION['kr_delivery_options']['delivery_instruction'];
}
...
<div class="sections section-grey2 section-payment-option">
    <div class="container">
          ...
          ?>
	        ...
	        ?>
                    ...
                    <div class="top10">
                        ...
                        <div class="row top10">
                            <div class="col-md-10">
                                <?php echo CHtml::textField('first_name',isset($client_info['first_name'])?$client_info['first_name']:'',array(
	               ...
	               'data-validation'=>"required"
                        ...
                        <div class="row top10">
                            <div class="col-md-10">
                                <?php echo CHtml::textField('last_name',isset($client_info['last_name'])?$client_info['last_name']:'',array(
	               'class'=>'grey-fields full-width',
             ...
             ?>
                 ...
                 ,array(
	               ...
	               'maxlength'=>15
                        ...
                        <div class="row top10">
                            <div class="col-md-10">
                                <?php echo CHtml::textField('delivery_instruction',isset($client_info['delivery_instruction'])?$client_info['delivery_instruction']:'',array(
	               'class'=>'grey-fields full-width',
	              ...
	              ?>
                        ...
                        <div class="row top10">
                            <div class="col-md-10">
                                <?php echo CHtml::textField('email_address',isset($client_info['email_address'])?$client_info['email_address']:'',array(
	               'class'=>'grey-fields full-width',
     ...
     ?>
                    ...
                    <div class="uk-panel uk-panel-box">
                        <ul class="tip-wrapper">
                            <li><a class="tips tip_cash" href="javascript:;" data-type="cash"
                                    data-tip="0"><?php echo t("No Tip")?></a></li>
                            ...
                            <?php endforeach;?>
                            <li style="display: none;"><?php echo CHtml::textField('tip_value','',array(
	 ...
	 ?>
        ...
        <div class="col-md-5 border sticky-div">
