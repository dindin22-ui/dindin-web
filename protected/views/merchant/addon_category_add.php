...
Widgets::multipleFields(array(
  'AddOn Name','Send to Printer','Description'
),array(
  'subcategory_name','subcategory_print_name','subcategory_description'
),$data,array(
  true,false
));
?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Send to Printer")?></label>
  <?php echo CHtml::textField('subcategory_print_name',
  isset($data['subcategory_print_name'])?stripslashes($data['subcategory_print_name']):""
  ,array(
  'class'=>'uk-form-width-large'
  ))?>
</div>
