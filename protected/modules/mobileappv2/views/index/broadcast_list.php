...
<div class="modal fade" id="broadcastNewModal" tabindex="-1" role="dialog" aria-labelledby="broadcastNewModal" aria-hidden="true">
 <div class="modal-dialog" role="document">
      <div class="modal-content">
		...
		<?php 
		echo CHtml::dropDownList('radius','',mobileWrapper::milesAvailable(),array(
		  'class'=>"form-control",
		  'required'=>false
		));
		?>
		...
		<div class="form-group">
		<label><?php echo mt("Schedule Notification")?></label>
		<?php 
		echo CHtml::dateTimeLocalField('schedule_notifications','',array('class'=>"form-control",'required'=>false ));
		?>
		</div>
