...
<p><b><?php echo mobileWrapper::t("Report Order Email")?></b></p>

<div class="row">
    <div class="col-md-4">
        <?php echo CHtml::textField('mobileapp2_report_order_email', getOptionA('mobileapp2_report_order_email'),
        array('class'=>" form-control","placeholder"=>mt("Report order email") ));?>
    </div>
</div>  
