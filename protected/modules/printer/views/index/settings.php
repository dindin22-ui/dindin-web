...
<div class="row">
  ...
  <div class="form-group">
	...
	<?php 
	echo CHtml::textField('printer_user',getOptionA('printer_user'),array(
	'class'=>'form-control',
	));
	?>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
	...
	<?php 
	echo CHtml::textField('printer_ukey',getOptionA('printer_ukey'),array(
	'class'=>'form-control',
	));
	?>
  </div>
...
<div class="row">
  ...
  <div class="form-group">
	...
	echo CHtml::checkBox('printer_auto_print',
