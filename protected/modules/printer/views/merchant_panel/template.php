...
<div class="row">
  <div class="col-md-6">
     <a href="javascript:;" data-toggle="modal" data-target="#modal_tags" ><?php echo t("Available Tags")?></a>&nbsp;
     <a href="javascript:;" data-toggle="modal" data-target="#modal_printer_tags" ><?php echo t("Printer Tags")?></a>
     
     <span>| </span>
     <a href="javascript:;" class="load_template" data-id="1" data-target="mt_printer_receipt_tpl" ><?php echo t("Load Sample Template 1")?></a>
     <span>| </span>
     <a href="javascript:;"  class="load_template" data-id="2" data-target="mt_printer_receipt_tpl" ><?php echo t("Load Sample Template 2")?></a>
...
<div class="row">
  ...
  <div class="form-group">	
	<?php 
	echo CHtml::textArea('mt_printer_receipt_tpl',getOption($mtid,'mt_printer_receipt_tpl'),array(
	 'class'=>"form-control",
	 'style'=>"height:300px;"
	));
	?>
