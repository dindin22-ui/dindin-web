...
class MerchantappModule extends CWebModule
{
	...
	public function init()
	{
		...
		Yii::app()->clientScript->registerScriptFile(
			$assets_url."/vendor/fancybox/source/jquery.fancybox.js",
		CClientScript::POS_END
		);		
		...
		$cs->registerCssFile($assets_url."/vendor/uikit/css/uikit.almost-flat.css?ver=1.0");
		$cs->registerCssFile(
			$assets_url."/vendor/fancybox/source/jquery.fancybox-modified.css");
	}
