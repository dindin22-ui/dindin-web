...
<ul class="nav nav-tabs">
  ...
  <li><a data-toggle="tab" href="#newWidow"><?php echo merchantApp::t("New Window")?></a></li>
...
<DIV id="newWidow" class="tab-pane pad10">

<div class="form-group ">
	  <label class="col-sm-2 control-label"><?php echo merchantApp::t("Tab Name"); ?></label>
	  <div class="col-sm-8">
	    <?php 
	    echo CHtml::textField('tab_name',array(
	      'class'=>'form-control'      
	    ));
	    ?>   
	  </div>
	...
	<div class="form-group ">
	  <label class="col-sm-2 control-label"><?php echo merchantApp::t("Tab Link")?></label>
	  <div class="col-sm-8">
	    <?php 
	    echo CHtml::textField('tab_link',array(
	      'class'=>'form-control'      
	    ));
	    ?>   
	  </div>
	...
	<div col-sm-12>
	<?php echo CHtml::hiddenField('action','tabLinks')?>
	<table id="table_list" class="table table-hover tbl-menu-links">
		<thead>
		<tr>
			<th width="5%"><?php echo merchantApp::t("ID")?></th>
			<th><?php echo merchantApp::t("Name")?></th>
			<th><?php echo merchantApp::t("Link")?></th>
			<th><?php echo merchantApp::t("Date Created")?></th>
			<th><?php echo merchantApp::t("Action")?></th>
		</tr>
		</thead>
		<tbody> 
		</tbody>
