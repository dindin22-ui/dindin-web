...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=orderdindin_zebra',
			'emulatePrepare'   => true,
			'username'         => 'orderdindin_lion',
			'password'         => 'ng9EhLbQ8sAP',
			'charset'          => 'utf8',
			'tablePrefix'      => 'mt_',
	    ),		 
		// 'db'=>array(	        
// 		    'class'            => 'CDbConnection' ,
// 			'connectionString' => 'mysql:host=localhost;dbname=vcHa7MqUIB1s',
// 			'emulatePrepare'   => true,
// 			'username'         => 'dindinsi_dindinp',
// 			'password'         => 'dindinsi_dindinp',
// 			'charset'          => 'utf8',
// 			'tablePrefix'      => 'mt_',
// 	    ),			
...
function clientStatus()
{
	return array(
	 ...
	 'disabled'=>Yii::t("default",'disabled'),
